...
class BCVERSION : public Register
{
public:
  BCVERSION(Register::Value value = 0x0) : fBits(value) {;}
  BCVERSION(const BCVERSION& other) : fBits(other.fBits.to_ulong()) {;}
  virtual ~BCVERSION() {;}

  const BCVERSION& operator= (const BCVERSION& other) {fBits = other.fBits; return* this;}
  bool operator== (const BCVERSION& other) const {return fBits.to_ulong() == other.fBits.to_ulong();}
  ...
  // BCVERSION specific parameters
  static const Register::Access Access = Register::R;
  static const Register::Address Address = 0x20;
  static const Register::Type Type = Register::BC;

  // BCVERSION specific members:
  // TODO: implement BCVERSION specific members
