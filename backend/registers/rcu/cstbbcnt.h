...
public:
  ...
  const CSTBBCNT& operator= (const CSTBBCNT& other) {fBits = other.fBits; return* this;}
  bool operator== (const CSTBBCNT& other) const {return fBits.to_ulong() == other.fBits.to_ulong();}
  ...
  // CSTBBCNT specific parameters
  static const Register::Access Access = Register::R;
  static const Register::Address Address = 0x5127;
  static const Register::Type Type = Register::RCU;

  // CSTBBCNT specific members:
  // TODO: implement CSTBBCNT specific members
