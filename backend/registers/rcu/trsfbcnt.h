...
public:
  ...
  const TRSFBCNT& operator= (const TRSFBCNT& other) {fBits = other.fBits; return* this;}
  bool operator== (const TRSFBCNT& other) const {return fBits.to_ulong() == other.fBits.to_ulong();}
  ...
  // TRSFBCNT specific parameters
  static const Register::Access Access = Register::R;
  static const Register::Address Address = 0x5123;
  static const Register::Type Type = Register::RCU;

  // TRSFBCNT specific members:
  // TODO: implement TRSFBCNT specific members
