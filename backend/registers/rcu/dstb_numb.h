...
class DSTB_NUMB : public Register
{
public:
  DSTB_NUMB(Register::Value value = 0x0) : fBits(value) {;}
  DSTB_NUMB(const DSTB_NUMB& other) : fBits(other.fBits.to_ulong()) {;}
  virtual ~DSTB_NUMB() {;}

  const DSTB_NUMB& operator= (const DSTB_NUMB& other) {fBits = other.fBits; return* this;}
  bool operator== (const DSTB_NUMB& other) const {return fBits.to_ulong() == other.fBits.to_ulong();}
  ...
  // DSTB_NUMB specific parameters
  static const Register::Access Access = Register::R;
  static const Register::Address Address = 0x5129;
  static const Register::Type Type = Register::RCU;

  // DSTB_NUMB specific members:
  // TODO: implement DSTB_NUMB specific members
