...
class DSTB_BCNT : public Register
{
public:
  DSTB_BCNT(Register::Value value = 0x0) : fBits(value) {;}
  DSTB_BCNT(const DSTB_BCNT& other) : fBits(other.fBits.to_ulong()) {;}
  virtual ~DSTB_BCNT() {;}

  const DSTB_BCNT& operator= (const DSTB_BCNT& other) {fBits = other.fBits; return* this;}
  bool operator== (const DSTB_BCNT& other) const {return fBits.to_ulong() == other.fBits.to_ulong();}
  ...
  // DSTB_BCNT specific parameters
  static const Register::Access Access = Register::R;
  static const Register::Address Address = 0x5121;
  static const Register::Type Type = Register::RCU;

  // DSTB_BCNT specific members:
  // TODO: implement DSTB_BCNT specific members
